...
export default function YeniOgrenciPage() {
  return (
    <div className="space-y-6">
      <div>
        <Link href="/koc/ogrenciler" className="inline-flex items-center gap-1 text-sm text-zinc-500 hover:text-zinc-900 mb-2">
          <ArrowLeft className="h-4 w-4" /> Öğrencilerim
        </Link>
        <h1 className="text-2xl font-bold text-zinc-900">Yeni Öğrenci</h1>
        <p className="text-sm text-zinc-500 mt-1">
          Öğrencinin bilgilerini gir. Davet emaili otomatik gönderilecek; öğrenci portala kendi şifresiyle giriş yapacak.
        </p>
      </div>
