...
import { createStudentAction, updateStudentAction } from "@/app/admin/ogrenciler/actions"
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div className="space-y-1.5">
          ...
          <Input id="grade" name="grade" defaultValue={student?.grade ?? ""} placeholder="ör. 12. Sınıf" />
        </div>
        <div className="space-y-1.5">
      ...
      <div className="flex items-center gap-3 pt-2">
        <Button type="submit" variant="accent" disabled={pending}>
          {pending ? "Kaydediliyor..." : isEdit ? "Güncelle" : "Öğrenciyi Ekle"}
        </Button>
